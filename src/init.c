...
SEXP savvy_pgltc_apply_filter__impl(SEXP c_arg__bytes, SEXP c_arg__filter_type, SEXP c_arg__from, SEXP c_arg__to) {
    SEXP res = savvy_pgltc_apply_filter__ffi(c_arg__bytes, c_arg__filter_type, c_arg__from, c_arg__to);
...
SEXP savvy_pgltc_remove_filter__impl(SEXP c_arg__bytes, SEXP c_arg__from, SEXP c_arg__to) {
    SEXP res = savvy_pgltc_remove_filter__ffi(c_arg__bytes, c_arg__from, c_arg__to);
    return handle_result(res);
}
